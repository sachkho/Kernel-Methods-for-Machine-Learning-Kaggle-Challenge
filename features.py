#This file contains all the feature extractors, we tried maximizing the performance
#by using a combination of HOG, LBP and colour histograms. 
#We also added a cache to avoid recomputing the features every time since it took a lot of time to compute them.
